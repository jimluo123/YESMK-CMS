...
const Details = (props: any) => {
  ...
  const columns: ColumnsType<GoodsType> = [
    ...
    },
    {
      ...
      width: 100,
      render: (goodsImage) => <Image width={60} height={60} src={goodsImage} />,
    },
    {
      title: "商品描述",
      dataIndex: "goodsDesc",
    ...
    },
    {
      ...
      render: (text, record: any) =>
        "￥" + (record.goodsPrice * record.goodsCount).toFixed(2),
    },
  ];

  const handleRefresh = () => {};
  return (
    <BodyCard title="订单详情" showFooter={false} onRefresh={handleRefresh}>
